    ...
    <div class="container">
      <section>
        <div class="flex">
          <div class="max-w-xs">
            ...
            <div class="text-sm text-red-600" v-show="tickersError">
      ...
      <template v-if="tickers.length">
        ...
        <div>
          ...
          <div>
            Фільтр:
            <div class="mt-1 relative rounded-md shadow-md inline-flex">
              <input
                v-model="filter"
                type="text"
...
export default {
  ...
  methods: {
    ...
    add() {
      ...
      // проверка на унікальность
      if (this.tickers.some((el) => el.name === currentTicker.name)) {
        this.tickersError = true;
      } else {
